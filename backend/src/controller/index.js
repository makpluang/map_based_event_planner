...
const {addCheckPoints,getAllCheckPoints,getCheckPointById,updateCheckpoint,deleteCheckPoint}=require('./path/addCheckpoints')
const  {createNewPath,getAllCreatedPaths,getPathById,deleteParticularPath}=require('./path/addPath')
